...
function UpdatePassword() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      await api.put(`/update-password/${userId}`, data)
  ...
  return (
    <Container>
      ...
      <H1>MUDAR A SENHA DO USUÁRIO</H1>
      <H1>Olá, {sessionStorage.getItem('userName')}!!</H1>
      ...
      <Form onSubmit={handleSubmit} style={{ marginLeft: '-24px' }}>
        ...
        <Button style={{ marginTop: '27px', marginBottom: '70px' }}
          type="submit">Salvar Senha</Button>
      </Form>
